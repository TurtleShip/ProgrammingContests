/*
NOT MINE.
Copied this from http://nminhtu94.blogspot.com/2012/12/uva-11402-ahoy-pirates.html
*/
#include <iostream>
#include <cstdio>
#include <cmath>
...
void update(int vertex, int l, int r, int i, int j, char type) {
	...
	if (l>=i && r<=j) return;
		...
		if (l>j || r<i) return;  // targetR < curL || curR < targetL   //If it's out then quit
		else
		{
