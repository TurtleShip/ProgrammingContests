...
double PrinceXToastbook::eat(vector <int> prerequisite) {
    ...
    REP(i,0,N)
    {
        ...
        //cycle exists for this book
        //No possible case exists where this book can be understood
        if(topSort[i] >= N) continue;
        
        /*
         To understand the current book, 
         we only need topSort[i] number of books to be read before it.
         In other words, we can read rem number of books 
         whenever we want.
         */
